...
# from openpom.feat.base_classes_custom import Featurizer, UserDefinedFeaturizer
...
class CSVLoader(DataLoader):
    ...
    def _featurize_shard(self,
        ...
        features = [elt for elt in self.featurizer(datapoints=shard[self.feature_field], fp_dim=self.fp_dim)]
        valid_inds = np.array(
